...
namespace SacramentPlanner.Controllers
{
    public class AgendaController : Controller
    {
        ...
        */
        ...
        {
            ViewData["MemberID"] = new SelectList(_context.Directory.OrderBy(x => x.Last_Name), "DirectoryID", "Full_Name");
            ViewData["HymnID"] = new SelectList(_context.Hymn.OrderBy(x => x.Hymn_Number), "HymnID", "Hymn_Number_Name");
